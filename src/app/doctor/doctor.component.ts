...
export class DoctorComponent implements OnInit {
  ...
  id;
  constructor(private router: Router, private ds: DoctorService, private route: ActivatedRoute, private tss: TokenStorageService, private spSer: SpecializationService,
